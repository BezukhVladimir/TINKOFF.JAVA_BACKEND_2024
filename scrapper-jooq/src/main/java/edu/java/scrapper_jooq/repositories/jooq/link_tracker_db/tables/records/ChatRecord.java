...
public class ChatRecord extends UpdatableRecordImpl<ChatRecord> implements Record2<Long, OffsetDateTime> {
    ...
    /**
     * Setter for <code>LINK_TRACKER_DB.CHAT.ID</code>.
     */
    ...
    /**
     * Getter for <code>LINK_TRACKER_DB.CHAT.ID</code>.
     */
    ...
    /**
     * Setter for <code>LINK_TRACKER_DB.CHAT.CREATED_AT</code>.
     */
    ...
    /**
     * Getter for <code>LINK_TRACKER_DB.CHAT.CREATED_AT</code>.
     */
    @jakarta.validation.constraints.NotNull
    @NotNull
     ...
     * Create a detached, initialised ChatRecord
     */
    public ChatRecord(edu.java.scrapper_jooq.repositories.jooq.link_tracker_db.tables.pojos.Chat value) {
        super(Chat.CHAT);

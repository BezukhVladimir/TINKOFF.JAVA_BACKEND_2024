...
public class LinkService {
    ...
    public LinkResponse add(Long chatId, URI url) {
        ...
        try {
            link = linkRepository.add(chatId, url.toString());
    ...
    public LinkResponse remove(Long chatId, URI url) {
        ...
        try {
            linkRepository.remove(chatId, url.toString());
        ...
        return mapToLinkResponse(new Link(chatId, url.toString(), OffsetDateTime.now()));
    }
